<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemDepartmentEdit.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.DepartmentManage.UCSystemDepartmentEdit" %>
