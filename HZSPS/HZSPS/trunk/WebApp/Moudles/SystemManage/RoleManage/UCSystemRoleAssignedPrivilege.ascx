<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemRoleAssignedPrivilege.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.RoleManage.UCSystemRoleAssignedPrivilege" %>
...
<ext:ResourceManagerProxy ID="ResourceManagerProxy1" runat="server" />
        ...
        <ext:Window 
                        ...
                        <ext:LayoutColumn ColumnWidth="0.5">
                           <ext:GridPanel runat="server" ID="GridPanel1" EnableDragDrop="true"  StoreID="Store1">
                                <ColumnModel ID="ColumnModel1" runat="server">
	                                <Columns>
	                                    <ext:Column ColumnID="columnID" Header="PrivilegeID" DataIndex="id" />
                                        <ext:Column ColumnID="columnName" Header="PrivilegeEnName" DataIndex="name" />
	                                </Columns>
                                </ColumnModel>
                                <SelectionModel>
            ...
            <Buttons>
                <ext:Button ID="Button5" runat="server" Text="Save Selected Privileges" Icon="Disk">
                    <Listeners>
        ...
        <script type="text/javascript">
            ...
            {
                Ext.net.DirectMethods.UCSystemRoleAssignedPrivilege.Save_RolePermission(json,
                            {
