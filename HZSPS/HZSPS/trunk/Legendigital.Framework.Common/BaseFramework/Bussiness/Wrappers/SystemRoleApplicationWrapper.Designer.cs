...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    public partial class SystemRoleApplicationWrapper
    {
		...
		//internal static readonly ISystemRoleApplicationServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SystemRoleApplicationServiceProxyInstance;
