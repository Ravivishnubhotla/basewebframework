...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("yunshiivr");
            ...
            int feetime = Convert.ToInt32(this.Request.Params["Miu"]) ;

            string linkid = this.Request.Params["mobile"]+this.Request.Params["startime"];
