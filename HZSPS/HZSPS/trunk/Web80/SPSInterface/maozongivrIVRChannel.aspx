...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("maozongivr");
            ...
            int feetime = Convert.ToInt32(this.Request.QueryString["min"]) ;

            string linkid = this.Request.QueryString["msgid"];
