...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("haotianIVR");
	    ...
	    DateTime dtStart = DateTime.ParseExact(this.Request.QueryString["callAt"], "yyyyMMddHHmmss", new System.Globalization.CultureInfo("zh-cn", true));

	    DateTime dtEnd = DateTime.ParseExact(this.Request.QueryString["endCallAt"], "yyyyMMddHHmmss", new System.Globalization.CultureInfo("zh-cn", true));
			
	    double fTimeSecond = (dtEnd-dtStart).TotalSeconds;

            int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(fTimeSecond)/60)) ;		 

            string linkid = this.Request.QueryString["phoneno"] + this.Request.QueryString["callAt"];
