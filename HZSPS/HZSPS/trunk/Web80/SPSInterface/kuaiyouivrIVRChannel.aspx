...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("kuaiyouivr");
            ...
            DateTime startdate = Convert.ToDateTime(this.Request.QueryString["start"]);
            DateTime enddate = Convert.ToDateTime(this.Request.QueryString["end"]);
