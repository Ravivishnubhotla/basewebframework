...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("9012ivr");
	    ...
	    int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(Convert.ToInt32(this.Request.QueryString["utime"]))/60)) ;

            string linkid = this.Request.QueryString["mobile"] + this.Request.QueryString["stime"];
