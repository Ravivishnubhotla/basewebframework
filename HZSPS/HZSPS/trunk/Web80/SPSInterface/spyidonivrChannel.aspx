...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("spyidonivr");
	        ...
	        string feetimeName = "feetime";
 	        string spCodeName = "longnum";

            int feetime = Convert.ToInt32(this.Request.QueryString[feetimeName]) ;

            string linkid = this.Request.QueryString[linkIDName].GetHashCode().ToString("D15").Replace("-", "0").Replace("+", "1");
