...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("yidongxingliaivr");
            ...
            int feetime = Convert.ToInt32(this.Request.QueryString["content"]);

            string linkid = this.Request.QueryString["mobile"]+System.DateTime.Now.Ticks.ToString();

            for (int i = 0; i < feetime; i++)
            {
                HttpGetPostRequest request = new HttpGetPostRequest(httpRequest);

		if (request.RequestParams["cid"]==null)
		{
            request.RequestParams.Add("cid", linkid + "-" + i.ToString());
		}
		else
		{
            request.RequestParams["cid"] = linkid + "-" + i.ToString();
		}
