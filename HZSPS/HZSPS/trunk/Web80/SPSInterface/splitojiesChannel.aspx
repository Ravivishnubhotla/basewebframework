...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("splitojies");
	    ...
	    string reportCode = this.Request.QueryString["reportcode"].Trim();

	    string state = reportCode.Substring(0, 1);
	    ...
	    if(state!="1")
	    {
  	    ...
  	    string mo = reportCode.Substring(1, reportCode.Length-1);	

 
        HttpGetPostRequest request = new HttpGetPostRequest(httpRequest);

		request.RequestParams.Add("mo",mo);
