...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("zsivr");
            ...
            DateTime startdate = DateTime.ParseExact(this.Request.QueryString["starttime"], "yyyyMMddHHmmss", null); //Convert.ToDateTime(this.Request.QueryString["starttime"]);
