...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("spcemenivr");
            ...
            DateTime enddate = Convert.ToDateTime(this.Request.QueryString["endtime"]);
...
//Response.Write(feetime );
            ...
            {
//Response.Write(linkid + "-" + i.ToString());
