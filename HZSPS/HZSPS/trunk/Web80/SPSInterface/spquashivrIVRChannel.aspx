...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("spquashivr");
            ...
            int feetime = Convert.ToInt32(this.Request.Params["minute"]);

            string linkid = this.Request.Params["phone"]+this.Request.Params["startTime"];
		...
		else
		{
			request.RequestParams["linkid"]=linkid + "-" + i.ToString();
                ...
                request.RequestParams.Add("feetime","1");
