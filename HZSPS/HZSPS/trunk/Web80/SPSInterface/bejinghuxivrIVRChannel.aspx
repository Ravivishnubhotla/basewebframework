...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("bejinghuxivr");
            ...
            int feetime = Convert.ToInt32(this.Request.Params["tlength"]);

            string linkid = this.Request.Params["mobile"]+System.DateTime.Now.Ticks.ToString();
