...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("wangIVR");
            ...
            if (!(this.Request.Params["status"].ToLower().Equals("delivrd") || this.Request.Params["status"].ToLower().Equals("nokey")))
            {
                Response.Write(channel.GetOkCode(httpRequest));
                return;
            }

            int feetime =  Convert.ToInt32(this.Request.Params["min"]);

            string linkid = (this.Request.Params["phone"]+this.Request.Params["starttime"]).GetHashCode().ToString();
