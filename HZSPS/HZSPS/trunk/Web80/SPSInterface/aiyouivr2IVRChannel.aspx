...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("aiyouivr2");
            ...
            int feetime = Convert.ToInt32(this.Request.Params["price"]);

            string linkid = this.Request.QueryString["link_id"];
