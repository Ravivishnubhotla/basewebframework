...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("3040ivr");
            ...
            int feetime = Convert.ToInt32(Convert.ToDouble(this.Request.QueryString["chargedDuration"])) ;

            string linkid = this.Request.QueryString["linkid"];
		...
		request.RequestParams.Add("spywid", request.RequestParams["callednumber"]);
