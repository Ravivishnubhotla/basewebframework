...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("yixinIVR");
	    ...
	    DateTime dtStart = DateTime.ParseExact(this.Request.QueryString["startdate"], "yyyy-MM-dd HH:mm:ss", new System.Globalization.CultureInfo("zh-cn", true));

	    DateTime dtEnd = DateTime.ParseExact(this.Request.QueryString["enddate"], "yyyy-MM-dd HH:mm:ss", new System.Globalization.CultureInfo("zh-cn", true));
			
	    double fTimeSecond = (dtEnd-dtStart).TotalSeconds;

            int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(fTimeSecond)/60)) ;		 

            string linkid = this.Request.QueryString["mobile"] + this.Request.QueryString["startdate"];
