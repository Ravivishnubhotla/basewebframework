...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("yitongivr");
            ...
            int feetime = Convert.ToInt32(this.Request.QueryString["datas"]) ;

            string linkid = this.Request.QueryString["mobile"] + this.Request.QueryString["sdate"];
