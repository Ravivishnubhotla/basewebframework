...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("qigongivr");
            ...
            DateTime startdate = Convert.ToDateTime(this.Request.QueryString["time_begin"]);
            DateTime enddate = Convert.ToDateTime(this.Request.QueryString["time_end"]);
            ...
            string linkid = this.Request.QueryString["mobile"]+startdate.Ticks.ToString();
