...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("haimivr");
            ...
            int feetime = Convert.ToInt32(this.Request.QueryString["length"]) ;
		...
		request.RequestParams.Add("spywid", request.RequestParams["spnum"]);
