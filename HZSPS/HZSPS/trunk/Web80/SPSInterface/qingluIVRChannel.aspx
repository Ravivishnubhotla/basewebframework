...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("ivrqinglu");
	    ...
	    string feetimeName = "minute";
 	    string spCodeName = "svcNum";

            int feetime = Convert.ToInt32(this.Request.QueryString[feetimeName]) ;

            string linkid = (this.Request.QueryString["phone"]+this.Request.QueryString["startTime"]).GetHashCode().ToString("D15").Replace("-", "0").Replace("+", "1");;
...
Response.Write(request.RequestParams["spywid"]);
