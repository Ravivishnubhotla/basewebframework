<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPCodeInfoEdit.ascx.cs"
    Inherits="Legendigital.Common.Web.Moudles.SPS.Codes.UCSPCodeInfoEdit" %>
<ext:Window ID="winSPCodeInfoEdit" runat="server" Icon="ApplicationEdit" Title="编辑公告"
    Width="600" Height="470" AutoShow="false" Maximizable="true" Modal="true" ShowOnLoad="false">
    <Body>
        <ext:FitLayout ID="fitLayoutMain" runat="server">
            <ext:FormPanel ID="formPanelSPCodeInfoEdit" runat="server" Frame="true" Header="false"
                AutoScroll="True" MonitorValid="true" BodyStyle="padding:5px;">
                <Body>
                    <ext:FormLayout ID="FormLayoutSPCodeInfo" runat="server" LabelSeparator=":" LabelWidth="100">
                        <Anchors>
                            ...
                            <ext:Anchor Horizontal="95%">
                                <ext:MultiField ID="mfCode" runat="server" FieldLabel="指令">
                                    <Fields>
                                        ...
                                        <ext:ComboBox ID="cmbCodeType" Editable="false" runat="server" AllowBlank="False"
                                            TriggerAction="All" SelectedIndex="0" Width="70">
                                            <Items>
                            ...
                            <ext:Anchor Horizontal="95%">
                                <ext:Checkbox ID="chkIsEnable" runat="server" FieldLabel="可用" />
                            </ext:Anchor>
                            <ext:Anchor Horizontal="95%">
    ...
    <Buttons>
        <ext:Button ID="btnSaveSPCodeInfo" runat="server" Text="编辑" Icon="ApplicationEdit">
            <AjaxEvents>
                <Click Before="if(!#{formPanelSPCodeInfoEdit}.getForm().isValid()) return false;"
                    OnEvent="btnSaveSPCodeInfo_Click" Success="Ext.MessageBox.alert('操作成功', '成功的编辑了通道信息。',callback);function callback(id) { #{storeSPCodeInfo}.reload(); };
" Failure="Ext.Msg.alert('操作失败', result.errorMessage);">
        ...
        <ext:Button ID="btnCancelSPCodeInfo" runat="server" Text="取消" Icon="Cancel">
            <Listeners>
                <Click Handler="#{winSPCodeInfoEdit}.hide();" />
            </Listeners>
        </ext:Button>
    </Buttons>
</ext:Window>
