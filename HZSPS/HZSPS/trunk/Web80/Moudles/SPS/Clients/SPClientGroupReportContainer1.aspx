<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SPClientGroupReportContainer1.aspx.cs" Inherits="Legendigital.Common.Web.Moudles.SPS.Clients.SPClientGroupReportContainer1" %>
    ...
    <ext:ViewPort ID="viewPortMain" runat="server">
        <Body>
            <ext:FitLayout ID="fitLayoutMain" runat="server">
                <Items>
                    <ext:Panel ID="ReportPanel" runat="server" Title="下家组结算报表" Icon="Table">
                        <TopBar>
