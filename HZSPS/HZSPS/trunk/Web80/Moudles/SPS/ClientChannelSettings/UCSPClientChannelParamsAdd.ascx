<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPClientChannelParamsAdd.ascx.cs" Inherits="Legendigital.Common.Web.Moudles.SPS.ClientChannelSettings.UCSPClientChannelParamsAdd" %>
