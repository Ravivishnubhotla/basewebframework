<%@ Page Language="C#" Theme="Standard" MasterPageFile="~/MasterPage/PageTemplate.Master"
    AutoEventWireup="true" Codebehind="EditPage.aspx.cs" Inherits="BaseWebManager.Module.FrameWork.SystemApplicationManage.RoleManage.EditPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="3">
        <tr>
            <td>
                <UcMenuHead:UCMenuHead ID="UCMenuHead1" runat="server" MoudleName="系统角色管理" OperationName=" 编辑系统角色">
        ...
        <tr>
            <td align="right">
                ...
                <asp:Button ID="btnSave" runat="server" CssClass="AdminButton" Text="保存" OnClick="btnSave_Click"
                    ValidationGroup="vgSystemRole" />&nbsp;<asp:Button ID="btnReturn" CssClass="AdminButton"
                        runat="server" CausesValidation="False" Text="返回列表" OnClick="btnReturn_Click" />
            </td>
        </tr>
        <tr>
            <td align="right">
                    ...
                    <AspAjax:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                        ...
                        <ContentTemplate>
                            <table width="100%" cellpadding="1" cellspacing="3" border="0">
                                ...
                                <tr>
                                    <td style="width: 15%; height: 40px;" class="table_body" align="left">
                                        角色描述:</td>
                                    <td class="table_none" colspan="3" style="height: 40px">
                                        <asp:TextBox ID="txtRoleDescription" ToolTip="输入角色描述" MaxLength='2000' TextMode="MultiLine"
                                            runat="server" ValidationGroup="vgSystemRole" Height="154px" Width="555px"></asp:TextBox>
                                        &nbsp;</td>
                                </tr>
                                <tr>
