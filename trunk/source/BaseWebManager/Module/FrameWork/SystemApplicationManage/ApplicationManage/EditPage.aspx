<%@ Page Language="C#" MasterPageFile="~/MasterPage/PageTemplate.Master" Theme="Standard"
    AutoEventWireup="true" Codebehind="EditPage.aspx.cs" Inherits="BaseWebManager.Module.FrameWork.SystemApplicationManage.ApplicationManage.EditPage" %>
        ...
        <tr>
            <td align="right">
                ...
                <asp:Button ID="btnSave" runat="server" CssClass="AdminButton" Text="保存" OnClick="btnSave_Click"
                    ValidationGroup="vgApplication" />&nbsp;<asp:Button ID="btnReturn" CssClass="AdminButton"
