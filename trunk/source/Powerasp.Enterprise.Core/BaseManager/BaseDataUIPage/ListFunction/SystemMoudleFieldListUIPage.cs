...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.ListFunction
{
    ...
    public class SystemMoudleFieldListUIPage : BaseDataListPage<SystemMoudleField>
    {
        ...
        protected override int GetDomainID(SystemMoudleField obj)
        {
            return obj.SystemMoudleFieldID;
        }
    }
}
