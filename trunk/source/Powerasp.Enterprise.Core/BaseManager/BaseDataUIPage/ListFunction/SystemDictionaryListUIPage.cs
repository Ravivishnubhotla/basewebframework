...
{
	[WebDataModule("系统字典表")]
    public class SystemDictionaryListUIPage : BaseDataListPage<SystemDictionary>
    {
        ...
        protected override int GetDomainID(SystemDictionary obj)
        {
            return obj.SystemDictionaryID;
        }
    }
}
