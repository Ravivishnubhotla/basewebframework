...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.EditFunction
{
    ...
    public class SystemRoleApplicationEditUIPage : BaseDataEditPage<SystemRoleApplication>
    {
        ...
        protected override void UpdateData(SystemRoleApplication obj)
        {
            systemRoleApplicationServiceInstance.Update(obj);
        }
    }
}
