...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.EditFunction
{
    ...
    public class SystemViewItemEditUIPage : BaseDataEditPage<SystemViewItem>
    {
        ...
        protected override void UpdateData(SystemViewItem obj)
        {
            systemViewItemServiceInstance.Update(obj);
        }
    }
}
