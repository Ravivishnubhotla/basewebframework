...
{
	[WebDataModule("系统资源")]
    public class SystemResourcesEditUIPage : BaseDataEditPage<SystemResources>
    {
        ...
        protected override void UpdateData(SystemResources obj)
        {
            systemResourcesServiceInstance.Update(obj);
        }
    }
}
