...
{
	[WebDataModule("系统短消息")]
    public class SystemShortMessageAddUIPage : BaseDataAddPage<SystemShortMessage>
    {
        ...
        protected override void SaveData(SystemShortMessage obj)
        {
            systemShortMessageServiceInstance.Create(obj);
        }
    }
}
