...
namespace Powerasp.Enterprise.Core.Utility
{
    ...
    public class ReflectionUtil
    {
        ...
        public static object CreateInstance(Type type, object[] args, BindingFlags flags)
        {
            ...
            if (info == null)
            {
                throw new NullReferenceException(string.Format("invaild constructor for name", info));
            }
            if (args == null)
            {
        ...
        public static Type GetType(string assemblyName, string typeName)
        {
            ...
            if (assembly == null)
            {
                throw new NullReferenceException(string.Format("invaild assembly for name", assemblyName));
            }
            Type type = assembly.GetType(typeName, false);
            if (type == null)
            {
                throw new NullReferenceException(string.Format("invaild type for name", type));
            }
            return type;
        }
