...
Ext.extend(Ext.grid.GroupSummary, Ext.util.Observable, {
    ...
    renderSummary: function(o, cs) {
        ...
        for (var i = 0, len = cs.length; i < len; i++) {
            ...
            if (cf.summaryType || cf.summaryRenderer) {
                p.value = (cf.summaryRenderer || c.renderer)(o.data[c.name], p, o, 0, i, this.grid.store);
            } else {
                p.value = '';
            }
    ...
    refreshSummaryById: function(gid) {
        ...
        this.grid.store.each(function(r) {
            if (Ext.util.Format.htmlDecode(r._groupId) == gid) {
                rs[rs.length] = r;
            }
        });
    ...
    doUpdate: function(ds, record) {
        this.refreshSummaryById(Ext.util.Format.htmlDecode(record._groupId));
    },
