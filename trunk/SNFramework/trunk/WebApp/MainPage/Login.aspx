...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ext:Window ID="extwinLogin" runat="server" Width="339" ButtonAlign="Right" Height="355"
        Title="TroniTech RMPlus Template System" Draggable="false" Closable="false" Maximizable="false" Modal="true" Icon="UserKey"
        Resizable="false">
        <content>
            <ext:BorderLayout ID="BorderLayout1" runat="server">
                <North>
                    <ext:Panel ID="Panel1" runat="server" Header="false" BaseCls="x-plain-body" Height="210px">
                        <Content>
                        </Content>
                    </ext:Panel>
                </North>
