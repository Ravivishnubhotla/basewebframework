...
namespace Legendigital.Framework.Common.Web.Handler
{
    public class DocumentViewHandler : IHttpHandler
    {
        ...
        public string OutPutType
        {
            get
            {
                if (string.IsNullOrEmpty(HttpContext.Current.Request.QueryString["OutPutType"]))
                    return "attachment";
                return HttpContext.Current.Request.QueryString["OutPutType"];
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.AddHeader("content-disposition", OutPutType + "; filename=" + Path.GetFileName(filePath));
