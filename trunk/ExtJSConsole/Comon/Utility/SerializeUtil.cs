...
namespace Legendigital.Framework.Common.Utility
{
    public static class SerializeUtil
    {
        ...
        public static string ToJsonNewTon<T>(T obj)
        {
            return Newtonsoft.Json.JsonConvert.SerializeObject(obj);
        }

        public static T JsonNewTonDeserialize<T>(string sJson) where T : class
        {
            return (T)Newtonsoft.Json.JsonConvert.DeserializeObject(sJson);
        }
