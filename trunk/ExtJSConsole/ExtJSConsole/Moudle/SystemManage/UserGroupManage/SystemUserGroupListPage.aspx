<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SystemUserGroupListPage.aspx.cs" Inherits="ExtJSConsole.Moudle.SystemManage.UserGroupManage.SystemUserGroupListPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showAddForm() {
                Coolite.AjaxMethods.UCSystemUserGroupAdd.Show( 
                                                                {
        ...
        function processcmd(cmd, id) {
            ...
            if (cmd == "cmdEdit") {
                Coolite.AjaxMethods.UCSystemUserGroupEdit.Show(id.id,
                                                                {
                                                                    failure: function(msg) {
                                                                        Ext.Msg.alert('操作失败', msg,RefreshData);
                                                                    },
    ...
    <ext:Store ID="storeSystemUserGroup" runat="server" AutoLoad="true" RemoteSort="true"
        ...
        <Reader>
            <ext:JsonReader ReaderID="GroupID">
                <Fields>
    ...
    <ext:ViewPort ID="viewPortMain" runat="server">
        <Body>
            <ext:FitLayout ID="fitLayoutMain" runat="server">
                <Items>
                    <ext:GridPanel ID="gridPanelSystemUserGroup" runat="server" StoreID="storeSystemUserGroup" StripeRows="true"
                        Title="用户组管理" Icon="Table">
                        <TopBar>
		...
		<ext:Column ColumnID="colGroupDescription" DataIndex="GroupDescription" Header="描述" Sortable="true">
                                </ext:Column>			
