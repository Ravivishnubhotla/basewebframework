...
<ext:Window ID="winSystemMoudleEdit" runat="server" Icon="ApplicationEdit" Title="编辑系统模块"
    ...
    <Body>
        <ext:FitLayout ID="fitLayoutMainSystemMoudle" runat="server">
            <ext:FormPanel ID="formPanelSystemMoudleEdit" runat="server" Frame="true" Header="false"
                MonitorValid="true" BodyStyle="padding:5px;">
                <Body>
                    <ext:FormLayout ID="formLayoutSystemMoudle" runat="server" LabelSeparator=":" LabelWidth="100">
                        <Anchors>
                            <ext:Anchor Horizontal="95%">
                                <ext:Hidden ID="hidSystemMoudleID" runat="server">
                                </ext:Hidden>
                            </ext:Anchor>
                            <ext:Anchor Horizontal="95%">
