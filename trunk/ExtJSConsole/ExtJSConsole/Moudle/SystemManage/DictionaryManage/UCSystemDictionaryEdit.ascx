<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemDictionaryEdit.ascx.cs"
    Inherits="ExtJSConsole.Moudle.SystemManage.DictionaryManage.UCSystemDictionaryEdit" %>
    ...
    <content>
            <ext:FormPanel ID="formPanelSystemDictionaryEdit" runat="server" Frame="true" Header="false"
                ...
                <items>
						...
						<ext:TextField ID="txtSystemDictionaryCategoryID" runat="server" FieldLabel="字典类型" AllowBlank="True"  AnchorHorizontal="95%"   />
