...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    ...
    public partial class SystemPrivilegeInRolesWrapper
    {
        ...
        public static List<SystemPrivilegeInRolesWrapper> FindAll(int firstRow, int maxRows, out int recordCount)
        {
            List<SystemPrivilegeInRolesEntity> list = businessProxy.FindAll(firstRow, maxRows, out recordCount);
            return ConvertToWrapperList(list);
        }
		
		public static List<SystemPrivilegeInRolesWrapper> FindAllByOrderBy(string orderByColumnName, bool isDesc, int pageIndex, int pageSize, out int recordCount)
        {
        ...
        public static List<SystemPrivilegeInRolesWrapper> FindAllByOrderByAndFilter(List<QueryFilter> filters, string orderByColumnName, bool isDesc, int pageIndex, int pageSize, out int recordCount)
        {
