<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SPChannelQuickAdd.ascx.cs"
    Inherits="Legendigital.Common.Web.Moudles.SPS.Channels.SPChannelQuickAdd" %>
<ext:Window ID="winSPChannelQuickAdd" runat="server" Icon="ApplicationAdd" Title="快速添加通道"
