...
namespace LD.SPPipeManage.Bussiness.DataContracts.Tables
{
	...
	/// </summary>
	[DataContract]
	public class SPSStatePaymentInfoDataContract
	{
        #region 公共常量

		public static readonly string CLASS_FULL_NAME = "LD.SPPipeManage.Bussiness.DataContracts.Tables.SPSStatePaymentInfoDataContract";
		...
		/// 默认构造函数
		/// </summary>
		public SPSStatePaymentInfoDataContract()
		{
			_id = 0;
			_mobileNumber = null;
			_channelID = null;
        ...
        public void FromWrapper(SPSStatePaymentInfoWrapper wrapper)
		{
			this.Id = wrapper.Id;
		...
		public SPSStatePaymentInfoWrapper ToWrapper()
        {
			SPSStatePaymentInfoWrapper wrapper = new SPSStatePaymentInfoWrapper();
			wrapper.Id = this.Id;
