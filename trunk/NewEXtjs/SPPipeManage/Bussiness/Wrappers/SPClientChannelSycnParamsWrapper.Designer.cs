...
namespace LD.SPPipeManage.Bussiness.Wrappers
{
    public partial class SPClientChannelSycnParamsWrapper
    {
		...
		internal static readonly ISPClientChannelSycnParamsServiceProxy businessProxy = ((LD.SPPipeManage.Bussiness.ServiceProxys.Tables.Container.ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID", typeof(LD.SPPipeManage.Bussiness.ServiceProxys.Tables.Container.ServiceProxyContainer)))).SPClientChannelSycnParamsServiceProxyInstance;
		//internal static readonly ISPClientChannelSycnParamsServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SPClientChannelSycnParamsServiceProxyInstance;

        internal SPClientChannelSycnParamsEntity entity;
        ...
        public static ILog Logger
        {
            ...
            {
                if (logger == null)
                    logger = LogManager.GetLogger(typeof(SPClientChannelSycnParamsWrapper));
                return logger;
            }
        }
        ...
        #region Construtor
        public SPClientChannelSycnParamsWrapper() : this(new SPClientChannelSycnParamsEntity())
        {
		...
		public static readonly string CLASS_FULL_NAME = "LD.SPPipeManage.Entity.Tables.SPClientChannelSycnParamsEntity";
		...
		internal static List<SPClientChannelSycnParamsWrapper> ConvertToWrapperList(List<SPClientChannelSycnParamsEntity> entitylist)
        {
            List<SPClientChannelSycnParamsWrapper> list = new List<SPClientChannelSycnParamsWrapper>();
            foreach (SPClientChannelSycnParamsEntity lentity in entitylist)
            {
		...
		internal static List<SPClientChannelSycnParamsWrapper> ConvertToWrapperList(IList<SPClientChannelSycnParamsEntity> entitylist)
        {
            List<SPClientChannelSycnParamsWrapper> list = new List<SPClientChannelSycnParamsWrapper>();
            foreach (SPClientChannelSycnParamsEntity lentity in entitylist)
            {
		...
		internal static List<SPClientChannelSycnParamsEntity> ConvertToEntityList(List<SPClientChannelSycnParamsWrapper> wrapperlist)
        {
            List<SPClientChannelSycnParamsEntity> list = new List<SPClientChannelSycnParamsEntity>();
            foreach (SPClientChannelSycnParamsWrapper wrapper in wrapperlist)
            {
