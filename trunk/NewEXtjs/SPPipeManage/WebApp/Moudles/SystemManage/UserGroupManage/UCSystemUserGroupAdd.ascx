    ...
    <Content>
        <ext:FormPanel ID="formPanelSystemUserGroupAdd" runat="server" Frame="true" Header="false"
            ...
            <Items>
						...
						<ext:TextField ID="txtGroupNameCn" runat="server" FieldLabel="User Group Name" AllowBlank="False"  AnchorHorizontal="95%" />
              
			
						<ext:TextField ID="txtGroupNameEn" runat="server" FieldLabel="User Group Code" AllowBlank="False"  AnchorHorizontal="95%" />
              
			
						<ext:TextField ID="txtGroupDescription" runat="server" FieldLabel="User Group Description" AllowBlank="True"  AnchorHorizontal="95%" />
