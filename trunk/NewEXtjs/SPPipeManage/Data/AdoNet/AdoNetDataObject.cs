...
namespace LD.SPPipeManage.Data.AdoNet
{
    ...
    public partial class AdoNetDataObject
    {
        ...
        {
            string sql = "select IsNull(Province,'未知省份') as ProvinceName,COUNT(*) as DataCount from SPPaymentInfo where ChannelID = @ChannelID and  ClientID =@ClientID and CreateDate>=@startDate and CreateDate<=@enddate {0} group by Province";
