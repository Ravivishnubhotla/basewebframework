...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    public partial class SystemResourcesWrapper
    {
		...
		//internal static readonly ISystemResourcesServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SystemResourcesServiceProxyInstance;
