...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    ...
    public partial class SystemPrivilegeWrapper
    {
        ...
        public static List<SystemPrivilegeWrapper> FindAll(int firstRow, int maxRows, out int recordCount)
        {
            List<SystemPrivilegeEntity> list = businessProxy.FindAll(firstRow, maxRows, out recordCount);
            return ConvertToWrapperList(list);
        }
		
		public static List<SystemPrivilegeWrapper> FindAllByOrderBy(string orderByColumnName, bool isDesc, int pageIndex, int pageSize, out int recordCount)
        {
        ...
        public static List<SystemPrivilegeWrapper> FindAllByOrderByAndFilter(List<QueryFilter> filters, string orderByColumnName, bool isDesc, int pageIndex, int pageSize, out int recordCount)
        {
