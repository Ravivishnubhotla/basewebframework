CREATE TABLE [dbo].[SPChannelSycnParams] (
    ...
    CONSTRAINT [PK_SPChannelSycnParams] PRIMARY KEY CLUSTERED ([ID] ASC),
    CONSTRAINT [FK_SPChannelSycnParams_SPChannel] FOREIGN KEY ([ChannelID]) REFERENCES [dbo].[SPChannel] ([ID]) ON DELETE CASCADE
);
