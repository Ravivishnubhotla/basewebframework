<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPClientChangeUserLoginInfo.ascx.cs" Inherits="SPSWeb.Moudles.SPS.Clients.UCSPClientChangeUserLoginInfo" %>
