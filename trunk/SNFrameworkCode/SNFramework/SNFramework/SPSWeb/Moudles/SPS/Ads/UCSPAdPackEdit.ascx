...
<ext:Window ID="winSPAdPackEdit" runat="server" Icon="ApplicationEdit" Title="Edit SPAdPack"
    ...
    <Buttons>
        <ext:Button ID="btnSaveSPAdPack" runat="server" Text="Edit" Icon="ApplicationEdit">
            <DirectEvents>
