<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemMenuManualResort.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.SystemApplicationAndMenus.UCSystemMenuManualResort" %>
