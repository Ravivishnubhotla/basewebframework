<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemOrganizationAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.OrginationDepartmentManage.UCSystemOrganizationAdd" %>
