<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemOperationAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.PermissionManage.UCSystemOperationAdd" %>
