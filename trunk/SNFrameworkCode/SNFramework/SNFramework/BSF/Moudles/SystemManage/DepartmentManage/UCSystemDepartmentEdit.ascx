<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemDepartmentEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.DepartmentManage.UCSystemDepartmentEdit" %>
