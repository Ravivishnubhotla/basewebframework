<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemUserGroupAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.UserGroupManage.UCSystemUserGroupAdd" %>
