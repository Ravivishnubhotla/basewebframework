<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemConfigEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.ConfigManage.UCSystemConfigEdit" %>
