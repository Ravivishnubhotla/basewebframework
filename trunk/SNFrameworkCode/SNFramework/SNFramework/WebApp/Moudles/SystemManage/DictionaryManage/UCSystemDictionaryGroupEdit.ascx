<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemDictionaryGroupEdit.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.DictionaryManage.UCSystemDictionaryGroupEdit" %>
<ext:Window ID="winSystemDictionaryGroupEdit" runat="server" Icon="ApplicationEdit" Title="Edit SystemDictionaryGroup"
    ...
    <Buttons>
        <ext:Button ID="btnSaveSystemDictionaryGroup" runat="server" Text="Edit" Icon="ApplicationEdit">
            <DirectEvents>
...
" Failure="Ext.Msg.alert('操作失败', result.errorMessage);">
        ...
        <ext:Button ID="btnCancelSystemDictionaryGroup" runat="server" Text="Cancel" Icon="Cancel">
            <Listeners>
