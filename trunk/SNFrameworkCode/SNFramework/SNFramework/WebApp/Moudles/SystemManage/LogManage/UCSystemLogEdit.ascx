<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemLogEdit.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.LogManage.UCSystemLogEdit" %>
