<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SPCodeListPage.aspx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SPS.Codes.SPCodeListPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ext:Viewport ID="viewPortMain" runat="server" Layout="fit">
        <Items>
            <ext:GridPanel ID="gridPanelSPCode" runat="server" StoreID="storeSPCode"
                StripeRows="true" Title="SPCode Management" Icon="Table">
                <TopBar>
		...
		<ext:Column ColumnID="colDisableCity" DataIndex="DisableCity" Header="DisableCity" Sortable="true">
                                </ext:Column>			
