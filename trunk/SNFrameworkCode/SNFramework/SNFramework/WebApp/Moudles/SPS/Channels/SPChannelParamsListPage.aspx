<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SPChannelParamsListPage.aspx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SPS.Channels.SPChannelParamsListPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <ext:Store ID="storeSPChannelParams" runat="server" AutoLoad="true" RemoteSort="true" RemotePaging="true"
    ...
    <ext:Viewport ID="viewPortMain" runat="server" Layout="fit">
        <Items>
            <ext:GridPanel ID="gridPanelSPChannelParams" runat="server" StoreID="storeSPChannelParams"
                StripeRows="true" Title="SPChannelParams Management" Icon="Table">
                <TopBar>
		...
		<ext:Column ColumnID="colParamsMappingName" DataIndex="ParamsMappingName" Header="ParamsMappingName" Sortable="true">
                                </ext:Column>			
		<ext:Column ColumnID="colTitle" DataIndex="Title" Header="Title" Sortable="true">
                                </ext:Column>			
				<ext:Column ColumnID="colShowInClientGrid" DataIndex="ShowInClientGrid" Header="ShowInClientGrid" Sortable="true">
                                    <Renderer Fn="FormatBool" />
                                </ext:Column>
		<ext:Column ColumnID="colParamsValue" DataIndex="ParamsValue" Header="ParamsValue" Sortable="true">
                ...
                <BottomBar>
                    <ext:PagingToolbar ID="PagingToolBar1" runat="server" PageSize="8" StoreID="storeSPChannelParams"
                        DisplayInfo="true" DisplayMsg="Display SPChannelParamss {0} - {1} total {2}" EmptyMsg="No matched SPChannelParams" />
                </BottomBar>
                <Listeners>
