...
namespace SPS.Data.Tables
{
    public partial class SPChannelParamsConvertDataObject : BaseNHibernateDataObject<SPChannelParamsConvertEntity>
    {
		...
		#endregion
		public static readonly IntProperty PROPERTY_CREATEBY = new IntProperty(Property.ForName(SPChannelParamsConvertEntity.PROPERTY_NAME_CREATEBY));		
		public static readonly DateTimeProperty PROPERTY_CREATEAT = new DateTimeProperty(Property.ForName(SPChannelParamsConvertEntity.PROPERTY_NAME_CREATEAT));		
		public static readonly IntProperty PROPERTY_LASTMODIFYBY = new IntProperty(Property.ForName(SPChannelParamsConvertEntity.PROPERTY_NAME_LASTMODIFYBY));		
		public static readonly DateTimeProperty PROPERTY_LASTMODIFYAT = new DateTimeProperty(Property.ForName(SPChannelParamsConvertEntity.PROPERTY_NAME_LASTMODIFYAT));		
		public static readonly StringProperty PROPERTY_LASTMODIFYCOMMENT = new StringProperty(Property.ForName(SPChannelParamsConvertEntity.PROPERTY_NAME_LASTMODIFYCOMMENT));		
        ...
        public override void InClude_Parent_Table(string parent_alias, NHibernateDynamicQueryGenerator<SPChannelParamsConvertEntity> queryGenerator)
        {
            switch (parent_alias)
            {
	            case "ChannelID_SPChannelParamsConvertEntity_Alias":
                    queryGenerator.AddAlians(SPChannelParamsConvertEntity.PROPERTY_NAME_CHANNELID, PROPERTY_CHANNELID_ALIAS_NAME);
                    break;
