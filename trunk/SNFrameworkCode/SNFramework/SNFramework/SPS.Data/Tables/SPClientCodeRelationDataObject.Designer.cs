...
namespace SPS.Data.Tables
{
    public partial class SPClientCodeRelationDataObject : BaseNHibernateDataObject<SPClientCodeRelationEntity,int>
    {
		...
		public static readonly StringProperty PROPERTY_CHANNELSTATUS = new StringProperty(Property.ForName(SPClientCodeRelationEntity.PROPERTY_NAME_CHANNELSTATUS));		
	            ...
	            case "CodeID_SPClientCodeRelationEntity_Alias":
					switch (fieldName)
					{
                		...
                		case "CodeID_SPClientCodeRelationEntity_Alias.HasPhoneLimit":
							return typeof (bool);
                		case "CodeID_SPClientCodeRelationEntity_Alias.HasDayMonthLimit":
							return typeof (bool);
                		...
                		case "CodeID_SPClientCodeRelationEntity_Alias.ParentID":
							return typeof (int);
                		case "CodeID_SPClientCodeRelationEntity_Alias.IsMatchCase":
							return typeof (bool);
                		case "CodeID_SPClientCodeRelationEntity_Alias.IsDayTimeLimit":
							return typeof (bool);
                		case "CodeID_SPClientCodeRelationEntity_Alias.DayTimeLimitRangeStart":
							return typeof (DateTime);
	            ...
	            case "ClientID_SPClientCodeRelationEntity_Alias":
					switch (fieldName)
					{
                		...
                		case "ClientID_SPClientCodeRelationEntity_Alias.DefaultShowRecordDays":
							return typeof (int);
                		case "ClientID_SPClientCodeRelationEntity_Alias.ChannelStatus":
							return typeof (string);
