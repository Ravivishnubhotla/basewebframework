// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SPUpperDataObject.Designer.cs">
...
{
    public partial class SPUpperDataObject : BaseNHibernateDataObject<SPUpperEntity,int>
    {
		...
		public static readonly StringProperty PROPERTY_LASTMODIFYCOMMENT = new StringProperty(Property.ForName(SPUpperEntity.PROPERTY_NAME_LASTMODIFYCOMMENT));		
        ...
        public override void InClude_Parent_Table(string parent_alias, NHibernateDynamicQueryGenerator<SPUpperEntity> queryGenerator)
        {
            switch (parent_alias)
            {
                default:
