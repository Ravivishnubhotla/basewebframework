...
{
    public interface ISystemDictionaryGroupServiceProxy : IBaseSpringNHibernateEntityServiceProxy<SystemDictionaryGroupEntity, int>, ISystemDictionaryGroupServiceProxyDesigner
    {
