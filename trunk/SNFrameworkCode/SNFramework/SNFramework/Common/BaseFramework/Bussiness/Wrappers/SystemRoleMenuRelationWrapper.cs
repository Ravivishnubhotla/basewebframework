...
{
	[Serializable]
    public partial class SystemRoleMenuRelationWrapper : BaseSpringNHibernateWrapper<SystemRoleMenuRelationEntity, ISystemRoleMenuRelationServiceProxy, SystemRoleMenuRelationWrapper>
    {
        ...
        public static List<SystemRoleMenuRelationWrapper> FindAllByOrderByAndFilter(List<QueryFilter> filters, string orderByFieldName, bool isDesc)
        {
