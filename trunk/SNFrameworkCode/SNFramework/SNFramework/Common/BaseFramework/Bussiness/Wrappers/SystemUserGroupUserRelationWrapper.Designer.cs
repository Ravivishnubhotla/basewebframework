...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    public partial class SystemUserGroupUserRelationWrapper    //: BaseSpringNHibernateWrapper<SystemUserGroupUserRelationEntity, ISystemUserGroupUserRelationServiceProxy, SystemUserGroupUserRelationWrapper,int>
    {
      ...
      #region 公共常量
		...
		public const string PROPERTY_USERID_VALIDATETYPE = "UserID_SystemUserGroupUserRelationEntity_Alias.ValidateType";
		public const string PROPERTY_USERID_ADDOMAIN = "UserID_SystemUserGroupUserRelationEntity_Alias.ADDomain";
		public const string PROPERTY_USERID_BINDUKEY = "UserID_SystemUserGroupUserRelationEntity_Alias.BindUKey";
		public const string PROPERTY_USERID_USBKEYSERIAL = "UserID_SystemUserGroupUserRelationEntity_Alias.USBKeySerial";
		public const string PROPERTY_USERID_USBKEYCODE = "UserID_SystemUserGroupUserRelationEntity_Alias.USBKeyCode";
		public const string PROPERTY_USERID_SSOKEY = "UserID_SystemUserGroupUserRelationEntity_Alias.SSOKey";
