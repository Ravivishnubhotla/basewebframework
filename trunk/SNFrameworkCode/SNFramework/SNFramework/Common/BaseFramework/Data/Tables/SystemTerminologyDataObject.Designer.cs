// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemTerminologyDataObject.Designer.cs">
...
{
    public partial class SystemTerminologyDataObject : BaseNHibernateDataObject<SystemTerminologyEntity,int>
    {
        ...
        public override void InClude_Parent_Table(string parent_alias, NHibernateDynamicQueryGenerator<SystemTerminologyEntity> queryGenerator)
        {
            switch (parent_alias)
            {
                default:
