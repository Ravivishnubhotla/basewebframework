// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemDictionaryGroupDataObject.Designer.cs">
...
{
    public partial class SystemDictionaryGroupDataObject : BaseNHibernateDataObject<SystemDictionaryGroupEntity,int>
    {
		#region Expression Query Property (标准查询字段)
		public static readonly IntProperty PROPERTY_ID = new IntProperty(Property.ForName(SystemDictionaryGroupEntity.PROPERTY_NAME_ID));		
		public static readonly StringProperty PROPERTY_NAME = new StringProperty(Property.ForName(SystemDictionaryGroupEntity.PROPERTY_NAME_NAME));		
		public static readonly StringProperty PROPERTY_CODE = new StringProperty(Property.ForName(SystemDictionaryGroupEntity.PROPERTY_NAME_CODE));		
        ...
        public override void InClude_Parent_Table(string parent_alias, NHibernateDynamicQueryGenerator<SystemDictionaryGroupEntity> queryGenerator)
        {
            switch (parent_alias)
            {
                default:
