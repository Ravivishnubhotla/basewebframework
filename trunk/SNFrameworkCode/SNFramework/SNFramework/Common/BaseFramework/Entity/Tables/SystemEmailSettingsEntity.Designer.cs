// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemEmailSettingsEntity.Designer.cs">
...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	/// </summary>
	[DataContract]
	public partial class SystemEmailSettingsEntity  : BaseTableEntity<int>,ICloneable
	{
      #region 公共常量
		...
		{
			 return this.CheckEquals(obj as SystemEmailSettingsEntity);
		}
