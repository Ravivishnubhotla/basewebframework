// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemNumberSeedEntity.Designer.cs">
...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	/// </summary>
	[DataContract]
	public partial class SystemNumberSeedEntity  : BaseTableEntity<int>,ICloneable
	{
      #region 公共常量
		...
		/// 全构造函数
		/// </summary>
		public SystemNumberSeedEntity( int id, string name, string code, string description, bool? isActive, string format, int? currentNumber, int? createBy, DateTime? createAt, int? lastModifyBy, DateTime? lastModifyAt, string lastModifyComment)
		{
			_id = id;
			_name = name;
			_code = code;
		...
		public virtual string Format
		{
			...
			set	
			{
				...
				if( value != null && value.Length > 200)
					throw new ArgumentOutOfRangeException("Invalid value for Format", value, value.ToString());
				_isChanged |= (_format != value); _format = value;
			}
		}
		...
		public virtual int? CurrentNumber
		{
			...
			set	
			{
				_isChanged |= (_currentNumber != value); _currentNumber = value;
			}
		}
		...
		{
			 return this.CheckEquals(obj as SystemNumberSeedEntity);
		}
