// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemTaskEntity.Designer.cs">
...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	public partial class SystemTaskEntity  : BaseTableEntity<int>,ICloneable
	{
      #region 公共常量
		...
		/// 全构造函数
		/// </summary>
		public SystemTaskEntity( int id, string title, string taskContent, int? assignedUserID, string status, DateTime? dateDue, DateTime? dateStart, DateTime? finishedDate, bool? isAlertInHome, bool? isRead, string priority, int? parentDataID, string parentDataType, int? createBy, DateTime? createAt, int? lastModifyBy, DateTime? lastModifyAt, string lastModifyComment)
		{
			_id = id;
			_title = title;
		...
		public virtual DateTime? FinishedDate
		{
			...
			set	
			{
				_isChanged |= (_finishedDate != value); _finishedDate = value;
			}
		}
		...
		/// </summary>
		[DataMember]
		public virtual bool? IsAlertInHome
		{
			get { return _isAlertInHome; }

			set	
			{
				_isChanged |= (_isAlertInHome != value); _isAlertInHome = value;
			}
		}
		...
		public virtual bool? IsRead
		{
			...
			set	
			{
				_isChanged |= (_isRead != value); _isRead = value;
			}
		}
