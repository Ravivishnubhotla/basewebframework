...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	public partial class SystemOrganizationEntity  : BaseTableEntity,ICloneable
	{
      #region 公共常量
		...
		/// 全构造函数
		/// </summary>
		public SystemOrganizationEntity( int id, string name, string code, string description, bool? isMainOrganization, int? createBy, DateTime? createAt, int? lastModifyBy, DateTime? lastModifyAt, string lastModifyComment)
		{
			_id = id;
			_name = name;
			_code = code;
