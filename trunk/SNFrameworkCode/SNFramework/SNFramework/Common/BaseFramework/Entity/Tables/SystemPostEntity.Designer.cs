// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemPostEntity.Designer.cs">
...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	/// </summary>
	[DataContract]
	public partial class SystemPostEntity  : BaseTableEntity<int>,ICloneable
	{
      #region 公共常量
		...
		/// 全构造函数
		/// </summary>
		public SystemPostEntity( int id, string name, string code, string description, SystemOrganizationEntity organizationID, int? createBy, DateTime? createAt, int? lastModifyBy, DateTime? lastModifyAt, string lastModifyComment)
		{
			_id = id;
			_name = name;
			_code = code;
		...
		{
			 return this.CheckEquals(obj as SystemPostEntity);
		}
