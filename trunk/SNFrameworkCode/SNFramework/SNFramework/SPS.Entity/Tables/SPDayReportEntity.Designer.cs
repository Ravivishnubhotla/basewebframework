...
namespace SPS.Entity.Tables
{
	...
	public partial class SPDayReportEntity : ICloneable
	{
		...
		/// 全构造函数
		/// </summary>
		public SPDayReportEntity( int id, DateTime? reportDate, int? totalCount, int? totalOkCount, int? totalFailedCount, int? interceptCount, int? downTotalCount, int? downSuccess, SPSClientEntity clientID, SPChannelEntity channelID, SPCodeEntity codeID, SPUpperEntity uperID)
		{
			_id = id;
			_reportDate = reportDate;
			_totalCount = totalCount;
			_totalOkCount = totalOkCount;
		...
		/// </summary>
		[DataMember]
		public virtual int? TotalOkCount
		{
			get { return _totalOkCount; }

			set	
			{
				_isChanged |= (_totalOkCount != value); _totalOkCount = value;
			}
		}
		...
		/// </summary>
		[DataMember]
		public virtual int? TotalFailedCount
		{
			get { return _totalFailedCount; }

			set	
			{
				_isChanged |= (_totalFailedCount != value); _totalFailedCount = value;
			}
		}
