...
namespace SPS.Bussiness.Wrappers
{
    public partial class SPClientCodeSycnParamsWrapper
    {
		...
		//internal static readonly ISPClientCodeSycnParamsServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SPClientCodeSycnParamsServiceProxyInstance;
        ...
        public static List<SPClientCodeSycnParamsWrapper> FindAllByOrderByAndFilterAndCodeID(string orderByColumnName, bool isDesc,int pageIndex, int pageSize,    SPCodeWrapper codeID,  out int recordCount)
        {
