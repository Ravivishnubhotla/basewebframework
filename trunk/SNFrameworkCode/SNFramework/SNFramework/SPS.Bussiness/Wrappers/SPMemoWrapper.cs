...
{
	[Serializable]
    public partial class SPMemoWrapper : BaseSpringNHibernateWrapper<SPMemoEntity, ISPMemoServiceProxy, SPMemoWrapper, int>  
    {
        ...
        public static SPMemoWrapper FindById(int id)
        {
