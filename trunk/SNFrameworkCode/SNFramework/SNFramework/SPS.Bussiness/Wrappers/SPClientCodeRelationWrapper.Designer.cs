...
namespace SPS.Bussiness.Wrappers
{
    public partial class SPClientCodeRelationWrapper
    {
		...
		//internal static readonly ISPClientCodeRelationServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SPClientCodeRelationServiceProxyInstance;
        ...
        public static List<SPClientCodeRelationWrapper> FindAllByOrderByAndFilterAndCodeID(string orderByColumnName, bool isDesc,int pageIndex, int pageSize,    SPCodeWrapper codeID,  out int recordCount)
        {
        ...
        public static List<SPClientCodeRelationWrapper> FindAllByOrderByAndFilterAndClientID(string orderByColumnName, bool isDesc,int pageIndex, int pageSize,    SPSClientWrapper clientID,  out int recordCount)
        {
        ...
        public static List<SPClientCodeRelationWrapper> FindAllByOrderByAndFilterAndSyncDataSetting(string orderByColumnName, bool isDesc,int pageIndex, int pageSize,    SPSDataSycnSettingWrapper syncDataSetting,  out int recordCount)
        {
            return ConvertToWrapperList(businessProxy.FindAllByOrderByAndFilterAndSyncDataSetting(orderByColumnName, isDesc,pageIndex, pageSize,   syncDataSetting.entity,out recordCount));
        }
