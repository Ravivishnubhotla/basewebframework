                        ...
                        <Anchors>
                            ...
                            <ext:Anchor Horizontal="95%">
                                <ext:Checkbox ID="chkDayTotalLimitInProvince" runat="server" FieldLabel="是否分省" Hidden="True">
                                    <Listeners>
                                        <Check Handler="CheckDayTotalLimitInProvince(#{chkDayTotalLimitInProvince}.getValue());">
                                        </Check>
                                    </Listeners>
                                </ext:Checkbox>
                            </ext:Anchor>
                            <ext:Anchor Horizontal="95%">
                                <ext:NumberField ID="numDefaultPrice" MinValue="0" DecimalPrecision="2" runat="server"
                                    FieldLabel="默认价格" AllowBlank="False" />
                            </ext:Anchor>
                            <ext:Anchor Horizontal="95%">
