<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPClientChannelParamsEdit.ascx.cs" Inherits="Legendigital.Common.Web.Moudles.SPS.ClientChannelSettings.UCSPClientChannelParamsEdit" %>
