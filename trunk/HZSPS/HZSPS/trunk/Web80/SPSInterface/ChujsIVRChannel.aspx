...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("chujsibr");
            ...
            DateTime startdate = Convert.ToDateTime(this.Request.QueryString["starttime"]);
            DateTime enddate = Convert.ToDateTime(this.Request.QueryString["stoptime"]);

 

            int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble((enddate - startdate).TotalSeconds)/60)) ;

            string linkid = this.Request.QueryString["mob"]+startdate.Ticks;
