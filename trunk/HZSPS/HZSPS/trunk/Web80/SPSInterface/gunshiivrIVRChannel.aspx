...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("gunshiivr");
            ...
            int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(Convert.ToInt32(this.Request.QueryString["DURATION"]))/60)) ;

            string linkid = this.Request.QueryString["CALLER"] + this.Request.QueryString["CALLINTIME"] + "1";
