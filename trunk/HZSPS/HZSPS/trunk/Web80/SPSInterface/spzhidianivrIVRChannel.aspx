...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("spzhidianivr");
            ...
            int feetime = Convert.ToInt32(this.Request.QueryString["discduration"]) ;

            feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(feetime )/60)) ;

            string linkid = (this.Request.QueryString["callernumber"]+this.Request.QueryString["starttime"]).GetHashCode().ToString("D15").Replace("-", "0").Replace("+", "1");;
