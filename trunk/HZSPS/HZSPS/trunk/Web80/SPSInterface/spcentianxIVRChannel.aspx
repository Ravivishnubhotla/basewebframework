...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("spcentianx");
            ...
            string linkid = this.Request.QueryString["mobpwd"];
		...
		if (request.RequestParams["mobpwd"]==null)
		{
			request.RequestParams.Add("mobpwd",linkid + "-" + i.ToString());
		}
		else
		{
			request.RequestParams["mobpwd"]=linkid + "-" + i.ToString();
		}
