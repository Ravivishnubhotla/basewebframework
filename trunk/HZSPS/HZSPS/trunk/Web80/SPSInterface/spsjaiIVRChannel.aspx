...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("spsjai");
            ...
            int feetime = Convert.ToInt32(this.Request.QueryString["time"]) ;

            string linkid = (Guid.NewGuid().ToString()).GetHashCode().ToString("D15").Replace("-", "0").Replace("+", "1");;
...
//Response.Write(linkid);
		...
		request.RequestParams.Add("ywid",this.Request.QueryString["cmd"]);

//foreach (DictionaryEntry dn in request.RequestParams) 
//{
//Response.Write(dn.Key.ToString()+"-------");
//Response.Write(dn.Value.ToString()+"\n");
//}
	    ...
	    //Response.Write("E3"+requestError1.ErrorMessage+requestError1.ErrorType);
            //其他错误类型记录错误请求
