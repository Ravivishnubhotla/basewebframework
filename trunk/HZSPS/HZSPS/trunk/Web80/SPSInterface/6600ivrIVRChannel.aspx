...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("6600ivr");
            ...
            int feetime =  Convert.ToInt32(this.Request.Params["dialtime"]);

            string linkid = this.Request.Params["callingid"]+this.Request.Params["begintime"];
