...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("youyouivr");
            ...
            int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(Convert.ToInt32(this.Request.QueryString["time_duration"]))/60)) ;

            string linkid = this.Request.QueryString["mobile"] + this.Request.QueryString["start_time"];
