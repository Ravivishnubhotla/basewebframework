...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("youletivr");
            ...
            string linkid = (this.Request.QueryString["mobile"]+this.Request.QueryString["start_time"]).GetHashCode().ToString("D15").Replace("-", "0").Replace("+", "1");;
