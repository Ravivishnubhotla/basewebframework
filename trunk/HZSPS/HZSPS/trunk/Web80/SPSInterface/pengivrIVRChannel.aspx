...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("pengivr");
            ...
            int feetime = Convert.ToInt32(this.Request.Params["alltime"]) ;

	    //string linkid = (this.Request.QueryString["mobile"]+this.Request.QueryString["starttime"]).GetHashCode().ToString("D15").Replace("-", "0").Replace("+", "1");;
