...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string channleName = "sptonyivr";
            string pNameStartTime = "startdate";
            string pNameEndTime = "enddate";
            string dateTimeFormat = "yyyy-MM-dd hh:mm:ss";
            string pNamePhone = "mobile";
            IHttpRequest httpRequest = new HttpGetPostRequest(Request);

            SPChannelWrapper channel = SPChannelWrapper.FindByAlias(channleName);
            ...
            DateTime startdate = Convert.ToDateTime(this.Request.QueryString[pNameStartTime]);  
            DateTime enddate = Convert.ToDateTime(this.Request.QueryString[pNameEndTime]); 
            ...
            string linkid = this.Request.QueryString[pNamePhone]+startdate.Ticks;
