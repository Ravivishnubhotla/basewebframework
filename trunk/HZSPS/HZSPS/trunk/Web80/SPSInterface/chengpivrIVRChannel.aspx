...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SPChannelWrapper channel = SPChannelWrapper.FindByAlias("chengpivr");
            ...
            int feetime = Convert.ToInt32(Math.Ceiling(Convert.ToDouble(Convert.ToInt32(this.Request.QueryString["length"]))/60)) ;

            string linkid = this.Request.QueryString["phone"]+this.Request.QueryString["time"];
