                            ...
                            Ext.net.DirectMethods.DeleteRecord(
                                                                id.id,
                                                                {
                                                                    ...
                                                                    success: function(result) { 
                                                                        Ext.Msg.alert('Operation successful', 'Delete successfulSystemConfig！',RefreshData);            
                                                                    },
                                                                    eventMask: {
                                                                                showMask: true,
                                                                                msg: 'Processing ......'
    ...
    <ext:Viewport ID="viewPortMain" runat="server" Layout="fit">
        <Items>
            <ext:GridPanel ID="gridPanelSystemConfig" runat="server" StoreID="storeSystemConfig"
                StripeRows="true" Title="SystemConfigManagement" Icon="Table">
                <TopBar>
				...
				<ext:Column ColumnID="colSystemConfigID" DataIndex="SystemConfigID" Header="SystemConfigID" Sortable="true">
                                </ext:Column>
		<ext:Column ColumnID="colConfigKey" DataIndex="ConfigKey" Header="ConfigKey" Sortable="true">
                                </ext:Column>			
		<ext:Column ColumnID="colConfigValue" DataIndex="ConfigValue" Header="ConfigValue" Sortable="true">
                                </ext:Column>			
		<ext:Column ColumnID="colConfigDescription" DataIndex="ConfigDescription" Header="ConfigDescription" Sortable="true">
                                </ext:Column>			
				<ext:Column ColumnID="colSortIndex" DataIndex="SortIndex" Header="SortIndex" Sortable="true">
                                </ext:Column>
 
                        <ext:CommandColumn Header="SystemConfigManagement" Width="160">
                            <Commands>
                ...
                <BottomBar>
                    <ext:PagingToolbar ID="PagingToolBar1" runat="server" PageSize="20" StoreID="storeSystemConfig"
                        DisplayInfo="true" DisplayMsg="ShowSystemConfig {0} - {1} total {2}" EmptyMsg="No matched recordSystemConfig" />
                </BottomBar>
                <Listeners>
