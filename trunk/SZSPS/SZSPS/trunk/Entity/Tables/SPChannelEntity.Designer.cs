...
namespace LD.SPPipeManage.Entity.Tables
{
	...
	public partial class SPChannelEntity : ICloneable
	{
		...
		/// </summary>
		[DataMember]
		public virtual string ChanneData
		{
			...
			set	
			{
				...
				_isChanged |= (_channeData != value); _channeData = value;
			}
		}
		...
		/// </summary>
		[DataMember]
		public virtual bool? HasConvertRule
		{
			get { return _hasConvertRule; }

			set	
			{
				_isChanged |= (_hasConvertRule != value); _hasConvertRule = value;
			}
		}
		/// <summary>
		/// 返回对象是否被改变。
