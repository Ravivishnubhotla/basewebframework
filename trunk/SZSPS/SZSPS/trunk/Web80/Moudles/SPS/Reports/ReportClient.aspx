<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="ReportClient.aspx.cs" Inherits="Legendigital.Common.Web.Moudles.SPS.Reports.ReportClient" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <ext:Store ID="storeSPClientAdd" runat="server" AutoLoad="false">
        <Proxy>
            <ext:HttpProxy Method="GET" Url="../Clients/SPClientHandlerByChannel.ashx" />
        </Proxy>
        <Reader>
        ...
        <BaseParams>
            <ext:Parameter Name="ClinetID" Value="#{cmbClinetID}.getValue()" Mode="Raw" />
        </BaseParams>
    </ext:Store>
    ...
    <ext:ScriptManagerProxy ID="ScriptManagerProxy1" runat="server">
        <Listeners>
            <DocumentReady Handler="#{storeSPChannelAdd}.reload();#{storeSPClientAdd}.reload();" />
        </Listeners>
                            ...
                            <ext:Toolbar ID="tbTop" runat="server">
                                <Items>
                                    ...
                                    <ext:ComboBox ID="cmbChannelID" runat="server" AllowBlank="true" StoreID="storeSPChannelAdd"
                                        ...
                                        EmptyText="全部">
                                        <Listeners>
                                            <Select Handler="#{cmbClinetID}.clearValue();#{storeSPClientAdd}.load();" />
                                        </Listeners>
                                    </ext:ComboBox>
                                    <ext:ToolbarTextItem Text="下家:">
                                    </ext:ToolbarTextItem>
                                    <ext:ComboBox ID="cmbClinetID" runat="server" AllowBlank="False" StoreID="storeSPClientAdd"
                                        TypeAhead="true" Mode="Local" TriggerAction="All" DisplayField="Name" ValueField="Id"
                                        EmptyText="全部" />
