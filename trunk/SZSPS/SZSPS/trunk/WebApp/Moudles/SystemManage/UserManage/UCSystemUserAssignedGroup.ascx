<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemUserAssignedGroup.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.UserManage.UCSystemUserAssignedGroup" %>
...
<ext:ResourceManagerProxy ID="ResourceManagerProxy1" runat="server" />
        ...
        <ext:Window 
            ...
            <Buttons>
                <ext:Button ID="Button5" runat="server" Text="Save Selected Groups" Icon="Disk">
                    <Listeners>
        ...
        <script type="text/javascript">
            ...
            {
                Ext.net.DirectMethods.UCSystemUserAssignedGroup.Save_UserGroup(json,
                            {
