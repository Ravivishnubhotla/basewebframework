<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemUserGroupAssignedRole.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.UserGroupManage.UCSystemUserGroupAssignedRole" %>
...
<ext:ResourceManagerProxy ID="ResourceManagerProxy1" runat="server" />
        ...
        <ext:Hidden ID="HiddenUserGroupID" runat="server"></ext:Hidden>
