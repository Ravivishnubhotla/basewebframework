<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemLogView.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.LogManage.UCSystemLogView" %>
