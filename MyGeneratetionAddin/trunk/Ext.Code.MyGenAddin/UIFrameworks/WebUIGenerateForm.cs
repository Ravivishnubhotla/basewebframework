...
{
    public class WebUIGenerateForm : BaseSingleObjectSelectorForm<WebUIGenerateConfig>
    {
        ...
        public override WebUIGenerateConfig DefaultConfig
        {
            get
            {
                WebUIGenerateConfig config = new WebUIGenerateConfig();
