    ...
    public class DefaultSettings
    {
        ...
        private string ApplicationPath
        {
            get
            {
                if (_appPath == null)
                {
                    string myGenerationPathString = "";

                    try
                    {
                        myGenerationPathString =
                            Registry.LocalMachine.OpenSubKey("SOFTWARE", true).OpenSubKey("MyGeneration13", true).GetValue(
                    ...
                    if (myGenerationPathString!="")
                        _appPath = myGenerationPathString;
                    else
                        _appPath = @"C:\Program Files\MyGeneration13\";
