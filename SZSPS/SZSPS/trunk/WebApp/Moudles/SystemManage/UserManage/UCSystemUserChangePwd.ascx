<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemUserChangePwd.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.UserManage.UCSystemUserChangePwd" %>
...
<ext:Window ID="winChangePassword" runat="server" Icon="UserKey" Title="Change Password"
    ...
    <Content>
        <ext:FormPanel ID="formPanelChangePassword" runat="server" Frame="true" Title="Change Password" MonitorValid="true" BodyStyle="padding:5px;" LabelSeparator=":" LabelWidth="130">
            <Items>
