...
{
    public partial class EditPage : SystemRoleEditUIPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.txtRoleName.Text = this.CurrentDataItem.RoleName.ToString();
            this.txtRoleDescription.Text = this.CurrentDataItem.RoleDescription.ToString();
            this.chkRoleIsSystemRole.Checked = this.CurrentDataItem.RoleIsSystemRole;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            SystemRole obj = this.CurrentDataItem;
