...
using Powerasp.Enterprise.Core.Compress.SevenZip.Common;
using Powerasp.Enterprise.Core.Compress.SevenZip.Compress.LzmaAlone;
using Decoder=Powerasp.Enterprise.Core.Compress.SevenZip.Compress.LZMA.Decoder;
using Encoder=Powerasp.Enterprise.Core.Compress.SevenZip.Compress.LZMA.Encoder;

namespace Powerasp.Enterprise.Core.Compress.SevenZip.Compress.LzmaAlone
{
