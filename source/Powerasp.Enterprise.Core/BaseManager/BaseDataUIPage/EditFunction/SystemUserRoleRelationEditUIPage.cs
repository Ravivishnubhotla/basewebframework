...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.EditFunction
{
    ...
    public class SystemUserRoleRelationEditUIPage : BaseDataEditPage<SystemUserRoleRelation>
    {
        ...
        protected override void UpdateData(SystemUserRoleRelation obj)
        {
            systemUserRoleRelationServiceInstance.Update(obj);
        }
    }
}
