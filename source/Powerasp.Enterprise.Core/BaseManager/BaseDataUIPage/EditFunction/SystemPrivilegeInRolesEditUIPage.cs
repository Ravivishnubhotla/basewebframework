...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.EditFunction
{
    ...
    public class SystemPrivilegeInRolesEditUIPage : BaseDataEditPage<SystemPrivilegeInRoles>
    {
        ...
        protected override void UpdateData(SystemPrivilegeInRoles obj)
        {
            systemPrivilegeInRolesServiceInstance.Update(obj);
        }
    }
}
