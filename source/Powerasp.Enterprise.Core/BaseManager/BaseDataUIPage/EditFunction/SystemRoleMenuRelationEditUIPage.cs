...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.EditFunction
{
    ...
    public class SystemRoleMenuRelationEditUIPage : BaseDataEditPage<SystemRoleMenuRelation>
    {
        ...
        protected override void UpdateData(SystemRoleMenuRelation obj)
        {
            systemRoleMenuRelationServiceInstance.Update(obj);
        }
    }
}
