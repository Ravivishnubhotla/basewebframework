...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.EditFunction
{
    ...
    public class SystemUserGroupUserRelationEditUIPage : BaseDataEditPage<SystemUserGroupUserRelation>
    {
        ...
        protected override void UpdateData(SystemUserGroupUserRelation obj)
        {
            systemUserGroupUserRelationServiceInstance.Update(obj);
        }
    }
}
