...
{
	[WebDataModule("权限参数")]
    public class SystemPrivilegeParameterListUIPage : BaseDataListPage<SystemPrivilegeParameter>
    {
        ...
        protected override int GetDomainID(SystemPrivilegeParameter obj)
        {
            return obj.PrivilegeParameterID;
        }
    }
}
