...
{
	[WebDataModule("系统应用")]
    public class SystemApplicationListUIPage : BaseDataListPage<SystemApplication>
    {
        ...
        protected override int GetDomainID(SystemApplication obj)
        {
            return obj.SystemApplicationID;
        }
    }
}
