...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.ListFunction
{
    ...
    public class SystemRoleMenuRelationListUIPage : BaseDataListPage<SystemRoleMenuRelation>
    {
        ...
        protected override int GetDomainID(SystemRoleMenuRelation obj)
        {
            return obj.MenuRoleID;
        }
    }
}
