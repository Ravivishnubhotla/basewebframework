...
namespace Powerasp.Enterprise.Core.BaseManager.BaseDataUIPage.ListFunction
{
    ...
    public class SystemPrivilegeInRolesListUIPage : BaseDataListPage<SystemPrivilegeInRoles>
    {
        ...
        protected override int GetDomainID(SystemPrivilegeInRoles obj)
        {
            return obj.PrivilegeRoleID;
        }
    }
}
