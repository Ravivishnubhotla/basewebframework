...
{
	[WebDataModule("系统设置")]
    public class SystemSettingAddUIPage : BaseDataAddPage<SystemSetting>
    {
        ...
        protected override void SaveData(SystemSetting obj)
        {
            systemSettingServiceInstance.Create(obj);
        }
    }
}
