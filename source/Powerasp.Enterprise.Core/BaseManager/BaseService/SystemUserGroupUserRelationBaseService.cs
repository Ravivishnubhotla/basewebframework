...
{
    [Transactional]
    public class SystemUserGroupUserRelationBaseService : BaseServices<SystemUserGroupUserRelation>
    {
        public SystemUserGroupUserRelationBaseService(SystemUserGroupUserRelationDao selfDao) : base(selfDao)
        {
        }
