...
{
    public partial class ReportDataOperatorService : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.IsPostBack)
                return;
            FixReportDefinition(this.Server.MapPath("ReportDataOperator.rdl"));
            ReportViewer1.LocalReport.ReportPath = this.Server.MapPath("ReportDataOperator.rdl");
            BindData();
        }
