<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemRoleAssignedApplication.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.RoleManage.UCSystemRoleAssignedApplication" %>
...
<ext:ResourceManagerProxy ID="ResourceManagerProxy1" runat="server" />
        ...
        <ext:Store runat="server" ID="Store1" AutoLoad="true"  OnRefreshData="Store1_OnRefreshData">         
            <Reader>
                <ext:JsonReader>
                    <Fields>
                        <ext:RecordField Name="id"  Mapping="SystemApplicationID" />
                        <ext:RecordField Name="name" Mapping="SystemApplicationName"/>        
                    </Fields>
                </ext:JsonReader>
            </Reader>
        </ext:Store>
        ...
        <ext:Window 
            ...
            Width="700"
            Icon="WorldAdd"
            Title="SystemApplication Selector"
            Padding="5"
            BodyBorder="false">
            <TopBar>
                        ...
                        <ext:LayoutColumn ColumnWidth="0.5">
                           <ext:GridPanel runat="server" ID="GridPanel1" EnableDragDrop="true"  StoreID="Store1">
                                <ColumnModel ID="ColumnModel1" runat="server">
	                                <Columns>
	                                    <ext:Column ColumnID="columnID" Header="SystemApplicationID" DataIndex="id" />
                                        <ext:Column ColumnID="columnName" Header="SystemApplicationName" DataIndex="name" />
	                                </Columns>
                                </ColumnModel>
                                <SelectionModel>
            ...
            <Buttons>
                <ext:Button ID="Button5" runat="server" Text="Save Selected SystemApplications" Icon="Disk">
                    <Listeners>
                        <Click Handler="btn555_Click(Ext.encode(#{GridPanel2}.getRowsValues(false)),#{Window1})" />
                    </Listeners>
                </ext:Button>
        ...
        <script type="text/javascript">
            function btn555_Click(json,Window1)
            {
                Ext.net.DirectMethods.UCSystemRoleAssignedApplication.Save_RoleApplication(json,
                            {
