...
namespace LD.SPPipeManage.Entity.Tables
{
	...
	/// </summary>
	[DataContract]
	public partial class SPSStatePaymentInfoEntity : ICloneable
	{
        #region 公共常量
		...
		/// 默认构造函数
		/// </summary>
		public SPSStatePaymentInfoEntity()
		{
			_id = 0;
			_mobileNumber = null;
			_channelID = null;
		...
		public override bool Equals( object obj )
		{
			...
			SPSStatePaymentInfoEntity castObj = (SPSStatePaymentInfoEntity)obj;
