...
namespace LD.SPPipeManage.Bussiness.Wrappers
{
    public partial class SPSStatePaymentInfoWrapper
    {
		...
		internal static readonly ISPSStatePaymentInfoServiceProxy businessProxy = ((LD.SPPipeManage.Bussiness.ServiceProxys.Tables.Container.ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID", typeof(LD.SPPipeManage.Bussiness.ServiceProxys.Tables.Container.ServiceProxyContainer)))).SPSStatePaymentInfoServiceProxyInstance;
		//internal static readonly ISPSStatePaymentInfoServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SPSStatePaymentInfoServiceProxyInstance;

        internal SPSStatePaymentInfoEntity entity;
        ...
        public static ILog Logger
        {
            ...
            {
                if (logger == null)
                    logger = LogManager.GetLogger(typeof(SPSStatePaymentInfoWrapper));
                return logger;
            }
        }
        ...
        #region Construtor
        public SPSStatePaymentInfoWrapper() : this(new SPSStatePaymentInfoEntity())
        {
		...
		public static readonly string CLASS_FULL_NAME = "LD.SPPipeManage.Entity.Tables.SPSStatePaymentInfoEntity";
        ...
        {
            List<SPSStatePaymentInfoWrapper> list = new List<SPSStatePaymentInfoWrapper>();
            foreach (SPSStatePaymentInfoEntity lentity in entitylist)
            {
		...
		internal static List<SPSStatePaymentInfoWrapper> ConvertToWrapperList(IList<SPSStatePaymentInfoEntity> entitylist)
        {
            List<SPSStatePaymentInfoWrapper> list = new List<SPSStatePaymentInfoWrapper>();
            foreach (SPSStatePaymentInfoEntity lentity in entitylist)
            {
		...
		internal static List<SPSStatePaymentInfoEntity> ConvertToEntityList(List<SPSStatePaymentInfoWrapper> wrapperlist)
        {
            List<SPSStatePaymentInfoEntity> list = new List<SPSStatePaymentInfoEntity>();
            foreach (SPSStatePaymentInfoWrapper wrapper in wrapperlist)
            {
