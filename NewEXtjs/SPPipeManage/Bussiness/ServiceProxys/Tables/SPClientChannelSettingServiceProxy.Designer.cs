...
namespace LD.SPPipeManage.Bussiness.ServiceProxys.Tables
{
    ...
    internal partial class SPClientChannelSettingServiceProxy : BaseSpringNHibernateEntityServiceProxy<SPClientChannelSettingEntity>
    {
        ...
        {
			return this.SelfDataObj.GetPageList_By_ClinetID_SPClientEntity(orderByColumnName, isDesc, pageIndex, pageSize,_clinetID, out recordCount);
        }
		
		public List<SPClientChannelSettingEntity> FindAllByClinetID(SPClientEntity _clinetID)
        {
			return this.SelfDataObj.GetList_By_ClinetID_SPClientEntity(_clinetID);
        }
