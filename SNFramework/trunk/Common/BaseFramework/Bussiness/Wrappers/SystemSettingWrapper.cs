...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    ...
    public partial class SystemSettingWrapper
    {
        ...
        {
            return  ConvertEntityToWrapper(businessProxy.GetCurrentSystemSetting());
        }

        public static void InstallSystem(SortedList<string, string> installParams)
        {
            businessProxy.InstallSystem(installParams);
        }
    }
}
