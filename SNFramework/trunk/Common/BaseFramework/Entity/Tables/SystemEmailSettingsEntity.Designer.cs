...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	public partial class SystemEmailSettingsEntity : ICloneable
	{
		...
		/// 全构造函数
		/// </summary>
		public SystemEmailSettingsEntity( int emailSettingID, string name, string descriprsion, string host, string port, bool? ssl, string fromEmail, string fromName, string loginEmail, string loginPassword, bool? isEnable, bool? isDefault, DateTime? createDate, int? createBy)
		{
