<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPClientCodeSycnParamsEdit.ascx.cs" Inherits="SPSWeb.Moudles.SPS.Codes.UCSPClientCodeSycnParamsEdit" %>
