...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.ServiceProxys.Tables
{
    ...
    public interface ISystemUserServiceProxy : IBaseSpringNHibernateEntityServiceProxy<SystemUserEntity, int>, ISystemUserServiceProxyDesigner
    {
        ...
        [OperationContract]
        bool CheckUserIfDeveloperAdminOrSystemAdmin(string loginID);
        [OperationContract]
    ...
    public partial class SystemUserServiceProxy : ISystemUserServiceProxy
    {
        ...
        public bool CheckUserIfDeveloperAdminOrSystemAdmin(string loginID)
        {
            return
                (bool)
                (loginID.ToUpper().Equals(DEV_USER_ID.ToUpper()) ||
                 loginID.ToUpper().Equals(SYS_USER_ID.ToUpper()));
        }
