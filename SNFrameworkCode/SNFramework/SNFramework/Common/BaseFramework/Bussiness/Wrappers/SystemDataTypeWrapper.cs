...
{
	[Serializable]
    public partial class SystemDataTypeWrapper : BaseSpringNHibernateWrapper<SystemDataTypeEntity, ISystemDataTypeServiceProxy, SystemDataTypeWrapper, int>
    {
        ...
        public static SystemDataTypeWrapper FindById(int id)
        {
