...
{
	[Serializable]
    public partial class SystemEmailTemplateWrapper : BaseSpringNHibernateWrapper<SystemEmailTemplateEntity, ISystemEmailTemplateServiceProxy, SystemEmailTemplateWrapper>
    {
