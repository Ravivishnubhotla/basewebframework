// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemTerminologyEntity.Designer.cs">
...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	/// </summary>
	[DataContract]
	public partial class SystemTerminologyEntity  : BaseTableEntity<int>,ICloneable
	{
      #region 公共常量
		...
		{
			 return this.CheckEquals(obj as SystemTerminologyEntity);
		}
