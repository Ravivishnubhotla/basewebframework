// --------------------------------------------------------------------------------------------------------------------
// <copyright company="foreveross" file="SystemUserDataObject.Designer.cs">
...
{
    public partial class SystemUserDataObject : BaseNHibernateDataObject<SystemUserEntity,int>
    {
		...
		public static readonly StringProperty PROPERTY_VALIDATETYPE = new StringProperty(Property.ForName(SystemUserEntity.PROPERTY_NAME_VALIDATETYPE));		
		public static readonly StringProperty PROPERTY_ADDOMAIN = new StringProperty(Property.ForName(SystemUserEntity.PROPERTY_NAME_ADDOMAIN));		
		public static readonly BoolProperty PROPERTY_BINDUKEY = new BoolProperty(Property.ForName(SystemUserEntity.PROPERTY_NAME_BINDUKEY));		
		public static readonly StringProperty PROPERTY_USBKEYSERIAL = new StringProperty(Property.ForName(SystemUserEntity.PROPERTY_NAME_USBKEYSERIAL));		
		public static readonly StringProperty PROPERTY_USBKEYCODE = new StringProperty(Property.ForName(SystemUserEntity.PROPERTY_NAME_USBKEYCODE));		
		public static readonly StringProperty PROPERTY_SSOKEY = new StringProperty(Property.ForName(SystemUserEntity.PROPERTY_NAME_SSOKEY));		
        ...
        public override void InClude_Parent_Table(string parent_alias, NHibernateDynamicQueryGenerator<SystemUserEntity> queryGenerator)
        {
            switch (parent_alias)
            {
                default:
