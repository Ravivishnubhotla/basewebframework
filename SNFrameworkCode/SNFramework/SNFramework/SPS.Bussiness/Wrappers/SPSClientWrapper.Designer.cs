...
namespace SPS.Bussiness.Wrappers
{
    public partial class SPSClientWrapper
    {
		...
		//internal static readonly ISPSClientServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SPSClientServiceProxyInstance;
        ...
        public static List<SPSClientWrapper> FindAllByOrderByAndFilterAndSyncDataSetting(string orderByColumnName, bool isDesc,int pageIndex, int pageSize,    SPSDataSycnSettingWrapper syncDataSetting,  out int recordCount)
        {
