...
{
    public partial class SPSDataSycnSettingWrapper
    {
        #region Member
		...
		//internal static readonly ISPSDataSycnSettingServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SPSDataSycnSettingServiceProxyInstance;
        ...
        public static ILog Logger
        {
            ...
            {
                if (logger == null)
                    logger = LogManager.GetLogger(typeof(SPSDataSycnSettingWrapper));
                return logger;
            }
        }
        ...
        #region Construtor
        public SPSDataSycnSettingWrapper() : this(new SPSDataSycnSettingEntity())
        {
