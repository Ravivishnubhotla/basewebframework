...
{
    public interface ISPMonitoringRequestServiceProxy : IBaseSpringNHibernateEntityServiceProxy<SPMonitoringRequestEntity, int>, ISPMonitoringRequestServiceProxyDesigner
    {
