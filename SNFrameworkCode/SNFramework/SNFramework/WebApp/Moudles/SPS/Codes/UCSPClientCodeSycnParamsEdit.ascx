<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPClientCodeSycnParamsEdit.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SPS.Codes.UCSPClientCodeSycnParamsEdit" %>
<ext:Window ID="winSPClientCodeSycnParamsEdit" runat="server" Icon="ApplicationEdit" Title="Edit SPClientCodeSycnParams"
    Width="400" Height="270" AutoShow="false" Maximizable="true" Modal="true" Hidden="true" AutoScroll="true"
    ConstrainHeader="true" Resizable="true"  Layout="fit">
    <Content>
        <ext:FormPanel ID="formPanelSPClientCodeSycnParamsEdit" runat="server" Frame="true" Header="false"
