<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPClientCodeSycnParamsView.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SPS.Codes.UCSPClientCodeSycnParamsView" %>
