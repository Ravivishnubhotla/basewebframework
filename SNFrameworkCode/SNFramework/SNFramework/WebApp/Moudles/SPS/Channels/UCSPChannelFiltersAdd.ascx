<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSPChannelFiltersAdd.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SPS.Channels.UCSPChannelFiltersAdd" %>
