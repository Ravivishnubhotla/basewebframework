<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemEmailTemplateView.ascx.cs" Inherits="Legendigital.Common.WebApp.Moudles.SystemManage.EmailTemplates.UCSystemEmailTemplateView" %>
<ext:Window ID="winSystemEmailTemplateView" runat="server" Icon="ApplicationViewDetail" Title="ShowSystemEmailTemplate"
    Width="400" Height="270" AutoShow="false" Maximizable="true" Modal="true" Hidden="true" AutoScroll="true"
    ConstrainHeader="true" Resizable="true" Layout="Fit">
    <Content>
        <ext:FormPanel ID="formPanelSystemEmailTemplateView" runat="server" Frame="true" Header="false"
            ...
            <Items>
					...
					<ext:DisplayField ID="lblTitleTemplate" runat="server" FieldLabel="TitleTemplate" AnchorHorizontal="95%" />
