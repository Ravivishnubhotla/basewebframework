CREATE TABLE [dbo].[SystemUser] (
    ...
    [PasswordFormat]              INT             CONSTRAINT [DF_SystemUser_PasswordFormat] DEFAULT ((0)) NOT NULL,
    ...
    [IsNeedChgPwd]                BIT             CONSTRAINT [DF_SystemUser_IsNeedChgPwd] DEFAULT ((0)) NOT NULL,
    [PasswordSalt]                NVARCHAR (128)  NULL,
    [LoweredEmail]                NVARCHAR (128)  NULL,
    [ValidateType]                NVARCHAR (50)   NULL,
    [ADDomain]                    NVARCHAR (500)  NULL,
    [BindUKey]                    BIT             NULL,
    [USBKeySerial]                NVARCHAR (50)   NULL,
    [USBKeyCode]                  NVARCHAR (500)  NULL,
    [SSOKey]                      NVARCHAR (50)   NULL,
    [CreateBy]                    INT             NULL,
    ...
    CONSTRAINT [PK_SystemUser] PRIMARY KEY CLUSTERED ([User_ID] ASC)
);
