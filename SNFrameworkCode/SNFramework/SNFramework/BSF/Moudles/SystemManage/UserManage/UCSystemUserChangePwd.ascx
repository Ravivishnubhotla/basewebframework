<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemUserChangePwd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.UserManage.UCSystemUserChangePwd" %>
