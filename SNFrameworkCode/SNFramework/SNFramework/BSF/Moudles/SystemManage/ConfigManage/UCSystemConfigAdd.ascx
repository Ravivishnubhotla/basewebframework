<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemConfigAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.ConfigManage.UCSystemConfigAdd" %>
