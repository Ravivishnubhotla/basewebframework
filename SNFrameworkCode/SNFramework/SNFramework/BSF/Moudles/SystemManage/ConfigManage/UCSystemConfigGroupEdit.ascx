<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemConfigGroupEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.ConfigManage.UCSystemConfigGroupEdit" %>
