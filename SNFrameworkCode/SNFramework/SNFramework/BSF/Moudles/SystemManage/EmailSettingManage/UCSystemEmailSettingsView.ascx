<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemEmailSettingsView.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.EmailSettingManage.UCSystemEmailSettingsView" %>
