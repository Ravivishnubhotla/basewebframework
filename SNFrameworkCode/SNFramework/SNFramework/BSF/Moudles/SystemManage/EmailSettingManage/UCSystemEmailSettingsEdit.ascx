<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemEmailSettingsEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.EmailSettingManage.UCSystemEmailSettingsEdit" %>
