<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemMenuAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.SystemApplicationAndMenus.UCSystemMenuAdd" %>
