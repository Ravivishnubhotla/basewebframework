<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemApplicationEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.SystemApplicationAndMenus.UCSystemApplicationEdit" %>
