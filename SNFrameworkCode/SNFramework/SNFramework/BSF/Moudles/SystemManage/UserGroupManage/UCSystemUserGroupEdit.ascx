<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemUserGroupEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.UserGroupManage.UCSystemUserGroupEdit" %>
