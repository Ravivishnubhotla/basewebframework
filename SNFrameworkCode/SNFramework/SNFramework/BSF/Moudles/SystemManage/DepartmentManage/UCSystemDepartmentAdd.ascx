<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemDepartmentAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.DepartmentManage.UCSystemDepartmentAdd" %>
