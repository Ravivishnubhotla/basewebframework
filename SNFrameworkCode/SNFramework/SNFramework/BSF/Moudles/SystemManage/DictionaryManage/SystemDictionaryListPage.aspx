<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/AdminMaster.Master" AutoEventWireup="true" CodeBehind="SystemDictionaryListPage.aspx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.DictionaryManage.SystemDictionaryListPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <ext:Store ID="storeSystemDictionary" runat="server" AutoLoad="true" RemoteSort="true"
        RemotePaging="true" OnRefreshData="storeSystemDictionary_Refresh">
        <AutoLoadParams>
