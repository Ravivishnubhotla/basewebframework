<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemDictionaryPatchAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.DictionaryManage.UCSystemDictionaryPatchAdd" %>
