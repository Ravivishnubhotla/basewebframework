<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemPostAdd.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.OrginationDepartmentManage.UCSystemPostAdd" %>
