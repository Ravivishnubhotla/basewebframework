<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSystemPostEdit.ascx.cs" Inherits="SNFramework.BSF.Moudles.SystemManage.OrginationDepartmentManage.UCSystemPostEdit" %>
