...
{
    public partial class SPCodeParamsConvertDataObject : BaseNHibernateDataObject<SPCodeParamsConvertEntity>
    {
		#region Expression Query Property (标准查询字段)
		public static readonly IntProperty PROPERTY_ID = new IntProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_ID));		
		public static readonly StringProperty PROPERTY_NAME = new StringProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_NAME));		
		public static readonly StringProperty PROPERTY_PARAMSVALUE = new StringProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_PARAMSVALUE));		
		public static readonly StringProperty PROPERTY_PARAMSCONVERTTO = new StringProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_PARAMSCONVERTTO));		
		public static readonly StringProperty PROPERTY_PARAMSCONVERTTYPE = new StringProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_PARAMSCONVERTTYPE));		
		public static readonly StringProperty PROPERTY_PARAMSCONVERTCONDITION = new StringProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_PARAMSCONVERTCONDITION));		
		public static readonly EntityProperty<SPCodeEntity> PROPERTY_CODEID = new EntityProperty<SPCodeEntity>(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_CODEID));
		#region codeID字段外键查询字段
        public static NHibernateDynamicQueryGenerator<SPCodeParamsConvertEntity> InClude_CodeID_Query(NHibernateDynamicQueryGenerator<SPCodeParamsConvertEntity> queryGenerator)
        {
            return queryGenerator.AddAlians(SPCodeParamsConvertEntity.PROPERTY_NAME_CODEID, PROPERTY_CODEID_ALIAS_NAME);
        }
		...
		public static readonly IntProperty PROPERTY_CREATEBY = new IntProperty(Property.ForName(SPCodeParamsConvertEntity.PROPERTY_NAME_CREATEBY));		
        ...
        public override void InClude_Parent_Table(string parent_alias, NHibernateDynamicQueryGenerator<SPCodeParamsConvertEntity> queryGenerator)
        {
            switch (parent_alias)
            {
	            case "CodeID_SPCodeParamsConvertEntity_Alias":
                    queryGenerator.AddAlians(SPCodeParamsConvertEntity.PROPERTY_NAME_CODEID, PROPERTY_CODEID_ALIAS_NAME);
                    break;
                default:
                    break;
		...
		public List<SPCodeParamsConvertEntity> GetList_By_CodeID_SPCodeEntity(SPCodeEntity fkentity)
		{
			NHibernateDynamicQueryGenerator<SPCodeParamsConvertEntity> dynamicQueryGenerator = this.GetNewQueryBuilder();
        ...
        public List<SPCodeParamsConvertEntity> GetPageList_By_CodeID_SPCodeEntity(string orderByColumnName, bool isDesc, SPCodeEntity fkentity, PageQueryParams pageQueryParams)
        {
            NHibernateDynamicQueryGenerator<SPCodeParamsConvertEntity> dynamicQueryGenerator = this.GetNewQueryBuilder();
