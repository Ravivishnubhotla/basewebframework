...
namespace SPS.Data.Tables
{
    public partial class SPRecordDataObject : BaseNHibernateDataObject<SPRecordEntity,int>
    {
		...
		public static readonly StringProperty PROPERTY_CLIENTCODERELATIONID_CHANNELSTATUS = new StringProperty(Property.ForName(PROPERTY_CLIENTCODERELATIONID_ALIAS_NAME + ".ChannelStatus"));
	            ...
	            case "ClientID_SPRecordEntity_Alias":
					switch (fieldName)
					{
                		...
                		case "ClientID_SPRecordEntity_Alias.Alias":
							return typeof (string);
                		case "ClientID_SPRecordEntity_Alias.IsEnable":
							return typeof (bool);
                		...
                		case "ClientID_SPRecordEntity_Alias.DefaultShowRecordDays":
							return typeof (int);
                		case "ClientID_SPRecordEntity_Alias.ChannelStatus":
							return typeof (string);
	            ...
	            case "CodeID_SPRecordEntity_Alias":
					switch (fieldName)
					{
                		...
                		case "CodeID_SPRecordEntity_Alias.HasPhoneLimit":
							return typeof (bool);
                		case "CodeID_SPRecordEntity_Alias.HasDayMonthLimit":
							return typeof (bool);
                		...
                		case "CodeID_SPRecordEntity_Alias.ParentID":
							return typeof (int);
                		case "CodeID_SPRecordEntity_Alias.IsMatchCase":
							return typeof (bool);
                		case "CodeID_SPRecordEntity_Alias.IsDayTimeLimit":
							return typeof (bool);
                		case "CodeID_SPRecordEntity_Alias.DayTimeLimitRangeStart":
							return typeof (DateTime);
                		case "CodeID_SPRecordEntity_Alias.DayTimeLimitRangeEnd":
							return typeof (DateTime);
                		case "CodeID_SPRecordEntity_Alias.DayTotalLimitInProvince":
							return typeof (bool);
                		case "CodeID_SPRecordEntity_Alias.DayTotalLimitInProvinceAssignedCount":
							return typeof (string);
                		case "CodeID_SPRecordEntity_Alias.ChannelStatus":
							return typeof (string);
	            ...
	            case "ClientCodeRelationID_SPRecordEntity_Alias":
					switch (fieldName)
					{
                		...
                		case "ClientCodeRelationID_SPRecordEntity_Alias.DefaultShowRecordDays":
							return typeof (int);
                		case "ClientCodeRelationID_SPRecordEntity_Alias.ChannelStatus":
							return typeof (string);
