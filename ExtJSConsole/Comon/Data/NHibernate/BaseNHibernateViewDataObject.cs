...
namespace Legendigital.Framework.Common.Data.NHibernate
{
                                                                     ...
                                                                     IBaseNHibernateViewDataObject<DomainType>
    {
        ...
        public List<DomainType> FindListByPageByQueryBuilder(NHibernateDynamicQueryGenerator<DomainType> queryBuilder,
                                                             out int recordCount)
        {
            return queryBuilder.FindListByPage(HibernateTemplate.SessionFactory.GetCurrentSession(), out recordCount);
        }
        ...
        public List<DomainType> FindAllByOrderBy(string orderByColumn, bool isDesc, int firstRow, int maxRows,
                                                 out int recordCount)
        {
            return FindAllByOrderByAndFilter(new List<QueryFilter>(), orderByColumn, isDesc, firstRow, maxRows,
                                             out recordCount);
        }
        ...
        public List<DomainType> FindDistinctListByPage(NHibernateDynamicQueryGenerator<DomainType> queryBuilder,
                                                       out int recordCount)
        {
            return queryBuilder.FindDistinctListByPage(HibernateTemplate.SessionFactory.GetCurrentSession(), out recordCount);
        }
