...
namespace Legendigital.Framework.Common.BaseFramework.Entity.Tables
{
	...
	public partial class SystemPrivilegeInRolesEntity : ICloneable
	{
		...
		/// 全构造函数
		/// </summary>
		public SystemPrivilegeInRolesEntity( int privilegeRoleID, SystemRoleEntity roleID, SystemPrivilegeEntity privilegeID, string privilegeRoleValue, string enableType, DateTime createTime, DateTime updateTime, DateTime expiryTime, bool enableParameter)
		{
