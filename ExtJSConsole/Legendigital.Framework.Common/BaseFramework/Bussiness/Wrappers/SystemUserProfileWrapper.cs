...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    ...
    public partial class SystemUserProfileWrapper
    {
        ...
        public static List<SystemUserProfileWrapper> FindAll(int firstRow, int maxRows, out int recordCount)
        {
            List<SystemUserProfileEntity> list = businessProxy.FindAll(firstRow, maxRows, out recordCount);
            return ConvertToWrapperList(list);
        }
		
		public static List<SystemUserProfileWrapper> FindAllByOrderBy(string orderByColumnName, bool isDesc, int pageIndex, int pageSize, out int recordCount)
        {
        ...
        public static List<SystemUserProfileWrapper> FindAllByOrderByAndFilter(List<QueryFilter> filters, string orderByColumnName, bool isDesc, int pageIndex, int pageSize, out int recordCount)
        {
