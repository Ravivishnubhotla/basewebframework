...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    public partial class SystemUserProfileWrapper
    {
		...
		//internal static readonly ISystemUserProfileServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SystemUserProfileServiceProxyInstance;
