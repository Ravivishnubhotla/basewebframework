...
namespace Legendigital.Framework.Common.BaseFramework.Bussiness.Wrappers
{
    public partial class SystemRoleMenuRelationWrapper
    {
		...
		//internal static readonly ISystemRoleMenuRelationServiceProxy businessProxy = ((ServiceProxyContainer)(ContextRegistry.GetContext().GetObject("ServiceProxyContainerIocID"))).SystemRoleMenuRelationServiceProxyInstance;
